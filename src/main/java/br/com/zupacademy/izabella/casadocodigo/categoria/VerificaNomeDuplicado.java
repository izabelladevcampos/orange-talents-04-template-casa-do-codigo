...
@Component
public class VerificaNomeDuplicado implements org.springframework.validation.Validator {
	...
	public void validate(Object target, Errors errors) {
		...
		if (possivelCategoria.isPresent()) {
			errors.rejectValue("nome", null, "Já existe uma categoria com o nome " + request.getNome() + ".");
		}
	}
